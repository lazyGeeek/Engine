...
namespace Engine::Renderer
{
    ...
    void OpenGL::Clear(bool colorBuffer, bool depthBuffer, bool stencilBuffer)
    {
        glClear
        (
    ...
    void OpenGL::SetRasterizationMode(Settings::ERasterizationMode rasterizationMode)
    {
        glPolygonMode(GL_FRONT_AND_BACK, static_cast<GLenum>(rasterizationMode));
    }

    void OpenGL::SetCapability(Settings::ERenderingCapability capability, bool value)
    {
        (value ? glEnable : glDisable)(static_cast<GLenum>(capability));
    }

    bool OpenGL::GetCapability(Settings::ERenderingCapability capability) const
    {
        return glIsEnabled(static_cast<GLenum>(capability));
    }

    void OpenGL::SetStencilAlgorithm(Settings::EComparaisonAlgorithm algorithm, int32_t reference, uint32_t mask)
    {
        glStencilFunc(static_cast<GLenum>(algorithm), reference, mask);
    }

    void OpenGL::SetDepthAlgorithm(Settings::EComparaisonAlgorithm algorithm)
    {
        glDepthFunc(static_cast<GLenum>(algorithm));
    }

    void OpenGL::SetStencilMask(uint32_t mask)
    {
        glStencilMask(mask);
    }

    void OpenGL::SetStencilOperations(Settings::EOperation stencilFail, Settings::EOperation depthFail, Settings::EOperation bothPass)
    {
        glStencilOp(static_cast<GLenum>(stencilFail), static_cast<GLenum>(depthFail), static_cast<GLenum>(bothPass));
    }

    void OpenGL::SetCullFace(Settings::ECullFace cullFace)
    {
        glCullFace(static_cast<GLenum>(cullFace));
    }

    void OpenGL::SetDepthWriting(bool enable)
    {
        glDepthMask(enable);
    }

    void OpenGL::SetColorWriting(bool enableRed, bool enableGreen, bool enableBlue, bool enableAlpha)
    {
    ...
    bool OpenGL::GetBool(GLenum parameter)
    {
        GLboolean result;
    ...
    bool OpenGL::GetBool(GLenum parameter, uint32_t index)
    {
        GLboolean result;
    ...
    int OpenGL::GetInt(GLenum parameter)
    {
        GLint result;
    ...
    int OpenGL::GetInt(GLenum parameter, uint32_t index)
    {
        GLint result;
    ...
    float OpenGL::GetFloat(GLenum parameter)
    {
        GLfloat result;
    ...
    float OpenGL::GetFloat(GLenum parameter, uint32_t index)
    {
        GLfloat result;
    ...
    double OpenGL::GetDouble(GLenum parameter)
    {
        GLdouble result;
    ...
    double OpenGL::GetDouble(GLenum parameter, uint32_t index)
    {
        GLdouble result;
    ...
    int64_t OpenGL::GetInt64(GLenum parameter)
    {
        GLint64 result;
    ...
    int64_t OpenGL::GetInt64(GLenum parameter, uint32_t index)
    {
        GLint64 result;
    ...
    std::string OpenGL::GetString(GLenum parameter)
    {
        const GLubyte* result = glGetString(parameter);
        return result ? reinterpret_cast<const char*>(result) : std::string();
    }

    std::string OpenGL::GetString(GLenum parameter, uint32_t index)
    {
