...
{
    Driver::Driver(const std::filesystem::path& shaderLocation) :
    ...
    void Driver::Init()
    {
        ...
        // if (!m_window)
        //     throw std::runtime_error("VULKAN: Can't create sdl2 window");
        ...
        if (glfwCreateWindowSurface(m_instance, window.GetWindow(), NULL, &m_surface))
            throw std::runtime_error("VULKAN: Can't create surface");
        ...
        if (m_queue == VK_NULL_HANDLE)
            throw std::runtime_error("VULKAN: Can't get device queue");
    ...
    void Driver::NewFrame()
    {
        ...
        std::cout << "submitInfo" << std::endl;
        VkSubmitInfo submitInfo;
        std::memset(&submitInfo, 0, sizeof(submitInfo));
        ...
        std::cout << "presentInfo" << std::endl;
        std::array<VkSwapchainKHR, 1> presentChain = { m_swapchain };
        VkPresentInfoKHR presentInfo;
        std::memset(&presentInfo, 0, sizeof(presentInfo));
    ...
    VkResult Driver::createInstance()
    {
    ...
    VkResult Driver::createPhysicalDevice()
    {
    ...
    VkResult Driver::createDevice()
    {
        ...
        std::memset(&deviceQueueInfo, 0, sizeof(deviceQueueInfo));
        ...
        std::memset(&deviceFeatures, 0, sizeof(deviceFeatures));
    ...
    VkResult Driver::createSwapchain()
    {
        std::memset(&m_swapchainExtent, 0, sizeof(m_swapchainExtent));

        const auto& size = Tools::Services::ServiceLocator::Get<Windows::GLFW>().GetSize();

        m_swapchainExtent.width = size.x;
        m_swapchainExtent.height = size.y;

        VkSwapchainCreateInfoKHR swapchainInfo;
        std::memset(&swapchainInfo, 0, sizeof(swapchainInfo));
        ...
        for (uint32_t i = 0; i < numSwapChainImgs; ++i)
        {
            ...
            std::memset(&viewCreateInfo, 0, sizeof(viewCreateInfo));
    ...
    VkResult Driver::createRenderPass()
    {
        ...
        std::memset(&colorAttachmentRef, 0, sizeof(colorAttachmentRef));
        ...
        std::memset(&dependency, 0, sizeof(dependency));
        ...
        std::memset(&renderPassInfo, 0, sizeof(renderPassInfo));
    ...
    VkResult Driver::createPipeline()
    {
        VkShaderModule vertexShaderModule = VK_NULL_HANDLE;

        std::vector<char> vertex = readFile(L"vertex.spv");

        VkShaderModuleCreateInfo shadeModuleInfo;
        std::memset(&shadeModuleInfo, 0, sizeof(shadeModuleInfo));
        ...
        std::memset(&vertexStageInfo, 0, sizeof(vertexStageInfo));
        ...
        std::vector<char> fragment = readFile(L"fragment.spv");
        ...
        std::memset(&fragmentStageInfo, 0, sizeof(fragmentStageInfo));
        ...
        std::memset(&bindingDescription, 0, sizeof(bindingDescription));
        ...
        std::memset(&vertexInputInfo, 0, sizeof(vertexInputInfo));
        ...
        std::memset(&inputAssemblyInfo, 0, sizeof(inputAssemblyInfo));
        ...
        std::memset(&viewportStateInfo, 0, sizeof(viewportStateInfo));
        ...
        std::memset(&rasterizationInfo, 0, sizeof(rasterizationInfo));
        ...
        std::memset(&multisamplingInfo, 0, sizeof(multisamplingInfo));
        ...
        std::memset(&blendMode, 0, sizeof(blendMode));
        ...
        std::memset(&blendInfo, 0, sizeof(blendInfo));
        ...
        std::memset(&dynamicStateInfo, 0, sizeof(dynamicStateInfo));
        ...
        std::memset(&pipelineInfo, 0, sizeof(pipelineInfo));
        ...
        std::memset(&graphicsPipelineInfo, 0, sizeof(graphicsPipelineInfo));
    ...
    VkResult Driver::createBuffer()
    {
        ...
        for (size_t i = 0; i < m_swapchainImageViews.size(); ++i)
        {
            ...
            std::memset(&framebufferInfo, 0, sizeof(framebufferInfo));
    ...
    VkResult Driver::createCommandPool()
    {
        VkCommandPoolCreateInfo commandPoolInfo;
        std::memset(&commandPoolInfo, 0, sizeof(commandPoolInfo));
    ...
    VkResult Driver::createVertexBuffer()
    {
        Vertex triangle[] =
        {
        ...
        std::memset(&allocateInfo, 0, sizeof(allocateInfo));
    ...
    VkResult Driver::createCommandBuffers()
    {
        m_commandBuffers = std::vector<VkCommandBuffer>(MAX_FRAMES_IN_FLIGHT, VkCommandBuffer{});
        VkCommandBufferAllocateInfo commandBufferAllocateInfo;
        std::memset(&commandBufferAllocateInfo, 0, sizeof(commandBufferAllocateInfo));
    ...
    VkResult Driver::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        VkCommandBuffer& cmdBuf = m_commandBuffers[imageIndex];

        VkCommandBufferBeginInfo beginInfo;
        std::memset(&beginInfo, 0, sizeof(beginInfo));
    ...
    VkResult Driver::createSemaphore()
    {
        VkResult result = VK_SUCCESS;
        ...
        std::memset(&symaphoreInfo, 0, sizeof(symaphoreInfo));
    ...
    VkResult Driver::createFence()
    {
        VkResult result = VK_SUCCESS;

        m_fences.resize(MAX_FRAMES_IN_FLIGHT);
        VkFenceCreateInfo fenceInfo;
        std::memset(&fenceInfo, 0, sizeof(fenceInfo));
    ...
    std::vector<char> Driver::readFile(const std::wstring& filename)
    {
        std::ifstream file(m_shaderLocation / filename, std::ios::ate | std::ios::binary);

        if (!file.is_open())
            throw std::runtime_error(std::string("VULKAN: ").append("Can't open file").c_str());
    ...
    uint32_t Driver::findMemoryType(VkPhysicalDevice& physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties)
    {
    ...
    VkResult Driver::createImguiDescriptorPool()
    {
        ...
        std::memset(&poolInfo, 0, sizeof(poolInfo));
    ...
    VkResult Driver::initImgui()
    {
        ...
        if (!ImGui_ImplGlfw_InitForVulkan(window.GetWindow(), true))
